...
var URL = {
    DOMAIN: "https://cartoonhd.press",
    SEARCH: 'https://api.cartoonhd.press/api/v1/0A6ru35yevokjaqbb3',
    TOKEN_API_EMBED: 'eCNBuxFGpRmFlWjUJjmjguCJI',
    EMBED_URL: 'https://cartoonhd.press/ajax/vsozrflxcw.php',
    KEY_SL: 'evokjaqbb3',
    HEADERS: {
...
var Cartoonhd = function () {
    function Cartoonhd(props) {
        _classCallCheck(this, Cartoonhd);
