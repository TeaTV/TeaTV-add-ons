...
var URL = {
    ...
    SEARCH: function SEARCH(title, nonce) {
        return 'https://tele.morphtv.club/api/gphoto';
    },
    ...
    _createClass(Tdn, [{
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                var _libs2, httpRequest, cheerio, qs, cryptoJs, _movieInfo2, title, year, season, episode, type, hosts, detailUrl, ss, ep, sign, posts, res, i, l;
