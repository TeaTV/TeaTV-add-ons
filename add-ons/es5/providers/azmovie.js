...
var URL = {
    DOMAIN: "https://azmovie.to",
    SEARCH: 'https://azmovie.to/livesearch.php',
    HEADERS: {
        'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        'Origin': 'https://azmovie.to',
...
var Azmovie = function () {
    function Azmovie(props) {
        _classCallCheck(this, Azmovie);
    ...
    _createClass(Azmovie, [{
        key: 'searchDetail',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                var _libs, httpRequest, cheerio, stringHelper, cryptoJs, qs, _movieInfo, title, year, season, episode, type;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                this.state.detailUrl = URL.DOMAIN + '/watch.php?title=' + title;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 7:
                                ...
                                if (!(htmlDetail.data.indexOf('No Movies were found by that name') != -1)) {
                                    _context2.next = 10;
                                    break;
                                }
